...
\fbox{\parbox{0.45\textwidth}{\centering [Captura de pestaña Parámetros:\\ Campos de geometría del casco,\\ distribución de masas,\\ parámetros de análisis]}}
...
\fbox{\parbox{0.45\textwidth}{\centering [Captura de pestaña Estabilidad:\\ Texto con resultados KB/BM/GM,\\ Gráficos de centros verticales,\\ Indicadores de flotación]}}
...
\fbox{\parbox{0.45\textwidth}{\centering [Captura de pestaña Resistencia:\\ 4 subplots con curvas,\\ R vs V, P vs V,\\ Re vs V, Fr vs V]}}
...
\fbox{\parbox{0.45\textwidth}{\centering [Captura de pestaña 3D:\\ Modelo 3D del casco,\\ Proa piramidal visible,\\ Popa rectangular,\\ Ejes X/Y/Z etiquetados]}}
...
\fbox{\parbox{0.45\textwidth}{\centering [Captura de pestaña Resumen:\\ Texto completo con todos\\ los resultados numéricos,\\ Verificación de especificaciones,\\ Botones Export TXT/JSON]}}
